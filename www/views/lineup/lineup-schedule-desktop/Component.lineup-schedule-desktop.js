(function () {
    ...
    angular.module('Lineup.view.module')
        .component('lineupScheduleDesktop', {
            bindings: {

            },
            templateUrl: 'views/lineup/lineup-schedule-desktop/lineup-schedule-desktop.html',
            controller: lineupScheduleDesktopCtrl,
            controllerAs: 'cc'
        })

    lineupScheduleDesktopCtrl.$inject = ['$log', '$rootScope', '$window', '$scope'];

    function lineupScheduleDesktopCtrl($log, $rootScope, $window, $scope) {
        var cc = this;
        ...
        cc.$onInit = function () {
            console.log('lineup schedule desktop')

            cc.lineupScheduleContent = [
                {
                    date: 'Fri Feb 3',
                    stages: [
                        {
