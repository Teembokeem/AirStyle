(function () {
    ...
    angular.module('Lineup.view.module')
        .component('lineupScheduleMobile', {
            bindings: {

            },
            templateUrl: 'views/lineup/lineup-schedule-mobile/lineup-schedule-mobile.html',
            controller: lineupScheduleMobileCtrl,
            controllerAs: 'cc'
        })

    lineupScheduleMobileCtrl.$inject = ['$log', '$rootScope', '$window', '$scope'];

    function lineupScheduleMobileCtrl($log, $rootScope, $window, $scope) {
        var cc = this;
        ...
        cc.$onInit = function () {
            console.log('lineup schedule mobile')
